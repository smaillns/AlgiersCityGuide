...
class GalleryAdapter(private var myListImages: ArrayList<String>, var mCtx: Context): RecyclerView.Adapter<GalleryAdapter.ViewHolder>(){
    ...
    override fun onBindViewHolder(holder: ViewHolder, position: Int) {
        ...
        mImageLoader.displayImage(RetrofitService.imageBaseUrl+"/Images/"+myListImages[position], imageAware,mDisplayImageOptions, mImageLoadingListener)
        ...
        holder.itemView.setOnClickListener(
                { view ->
                    ...
                    mImageLoader.displayImage(RetrofitService.imageBaseUrl+"/Images/"+myListImages[position], imageAware2,mDisplayImageOptions, mImageLoadingListener)
