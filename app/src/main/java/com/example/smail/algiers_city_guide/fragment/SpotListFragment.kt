...
import com.example.smail.algiers_city_guide.Query

import com.example.smail.algiers_city_guide.R
import com.example.smail.algiers_city_guide.activity.MainActivity
import com.example.smail.algiers_city_guide.adapter.SearchSuggestionAdapter
import com.example.smail.algiers_city_guide.adapter.SpotListAdapter
import com.example.smail.algiers_city_guide.content.SpotSearchRecentSuggestionsProvider
...
import com.example.smail.algiers_city_guide.database.RetrofitService.endPoint
...
import com.example.smail.algiers_city_guide.gelocation.GeolocationListener
...
import com.example.smail.algiers_city_guide.utility.NetworkManager
import com.example.smail.algiers_city_guide.view.GridSpacingItemDecoration
...
//                    Toast.makeText(getActivity()!!, "error server", Toast.LENGTH_SHORT).show()
                ...
                override fun onResponse(call: Call<List<TestDB>>?, response: Response<List<TestDB>>?) {
                    ...
                    if (nbr != mDataset.size && mCategoryId != CATEGORY_ID_FAVORITES) {
                        mDataset.clear()
