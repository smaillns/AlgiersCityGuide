...
import com.example.smail.algiers_city_guide.activity.MapActivity
...
import com.example.smail.algiers_city_guide.entity.TestDB
import com.example.smail.algiers_city_guide.graphics.BitmapScaler
import com.example.smail.algiers_city_guide.listener.AnimateImageLoadingListener
import com.example.smail.algiers_city_guide.utility.*
...
fun fillCateories(sp:Spot){
    ...
    val category_museum = Category(CATEGORY_ID_MUSEUM,"museums","markers/museums.png")
...
//        containerEmpty.visibility = View.VISIBLE
    ...
    fun initData() {
        mSpotList.add(Spot(1,"nom11","nom_en","alg",36.755 ,3.0417,"","","Description...","",null,null,
                "0552349395","www.algiers-city-guide.dz",0,null,null,null,null,Category(1,"All","markers/food.png",null)))

        mSpotList.add(Spot(2,"nom12","nom_en","alger.jpg",36.7525 ,3.06197,"","","Description...","",null,null,
        ...
        mSpotList.add(Spot(3,"nom13","nom_en","eiffeltower.jpg",36.7925 ,3.04197,"","","Description...","",null,null,
                "0552349395","www.algiers-city-guide.dz",
                0,null,null,null,null,Category(3,"All","markers/services.png",null)))


        mSpotList.add(Spot(4,"nom21","nom_en","eiffeltower.jpg",36.1525 ,3.0197,"","","Description...","",null,null,
                "0552349395","www.algiers-city-guide.dz",0,null,null,null,null,Category(4,"All","markers/sport.png",null)))

        mSpotList.add(Spot(5,"nom22","nom_en","eiffeltower.jpg",36.7565 ,3.14197,"","","Description...","",null,null,
                "0552349395","www.algiers-city-guide.dz",0,null,null,null,null,Category(4,"All","markers/sport.png",null)))
